...
# glimpse_output_size = 240  # Output size of Glimpse Network
...
#     source_data = readin(path + "UCI_HAR_train.txt")
#     # target_data = sc.loadmat(path + 'UCI_test_raw' + '.mat')
#     # target_data = target_data['UCI_test_raw']
#     target_data = readin(path + "UCI_HAR_test.txt")
...
# #print("num of features: ",nb_feature)
...
# #ram = GlobalConvolutionalRecurrentAttentionModel (img_width=img_width,
...
#         #     print(i)
#         #     confusion_matrix[int(target_y[i])-1][int(prediction[i])-1] += 1
...
# MH: nb_gpl = 40 lr = 5e-3, decay = 1 92%
# PAMP2 6: nb_gpl = 40 lr = 5e-3 decay = 0.998  96.5%
# UCI: nb_gpl = 40 lr = 5e-3 decay = 0.998 80%
# MARS:  nb_gpl = 40, gli_tim_down = 8, gil_loc_down = 8, lr = 5e-3, decay = 1 88%
